# Lines of Executable Code *(**deprecated**, will be removed in 4.0 version, use **[Source lines of Code](https://github.com/dart-code-checker/dart-code-metrics/blob/master/doc/metrics/source-lines-of-code.md)**)*
