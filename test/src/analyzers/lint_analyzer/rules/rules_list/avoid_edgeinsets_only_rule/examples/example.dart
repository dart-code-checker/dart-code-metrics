...
class StatelessWidget extends Widget {
  ...
  Widget build(BuildContext context) {
    return Container(padding: EdgeInsets.only(left: 20)); /// lint
  }

  Widget build2(BuildContext context) {
    return Container(
        padding: EdgeInsets.only(left: 20, right: 2, top: 1)); /// lint
  }

  Widget build3(BuildContext context) {
    return Container(
        padding: EdgeInsets.symmetric(horizontal: 3)); /// DO NOT LINT
  }
}
