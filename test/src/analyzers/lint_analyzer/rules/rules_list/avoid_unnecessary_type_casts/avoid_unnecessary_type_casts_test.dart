  ...
  group('AvoidUnnecessaryTypeCasts', () {
    ...
    test('reports about found all issues in example.dart', () async {
      ...
      RuleTestHelper.verifyIssues(
        issues: issues,
        startOffsets: [
          120, 228, 539, 584, 630, 672, 718, 968, 1089,
        ],
        startLines: [
          6, 8, 21, 22, 23, 24, 25, 32, 40,
        ],
        startColumns: [
          20, 21, 20, 20, 20, 20, 20, 16, 20,
        ],
        endOffsets: [
          143, 252, 555, 601, 643, 689, 731, 986, 1108,
        ],
        locationTexts: [
