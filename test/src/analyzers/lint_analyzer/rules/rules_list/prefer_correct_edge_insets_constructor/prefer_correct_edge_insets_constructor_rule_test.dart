    ...
    () {
      ...
      test(
        ...
        () async {
          ...
          RuleTestHelper.verifyIssues(
            ...
            replacementComments: [
              'Prefer use EdgeInsets.symmetric(horizontal: 5, vertical: 10)',
              'Prefer use EdgeInsetsDirectional.all(10)',
              'Prefer use EdgeInsets.symmetric(horizontal: 12, vertical: 10)',
              'Prefer use EdgeInsets.symmetric(vertical: 10)',
              'Prefer use EdgeInsets.symmetric(horizontal: 10)',
              'Prefer use EdgeInsets.symmetric(horizontal: 5, vertical: 10)',
              'Prefer use EdgeInsetsDirectional.all(10.0)',
              'Prefer use EdgeInsets.symmetric(horizontal: 12.0, vertical: 10.0)',
              'Prefer use EdgeInsets.symmetric(vertical: 10.0)',
              'Prefer use EdgeInsets.symmetric(horizontal: 10.0)',
            ],
      ...
      test('reports about found issues in steb constructor', () async {
        ...
        RuleTestHelper.verifyIssues(
          ...
          replacementComments: [
            'Prefer use EdgeInsetsDirectional.only(start: 1, top: 1)',
            'Prefer use EdgeInsetsDirectional.all(12)',
            'Prefer use EdgeInsetsDirectional.all(1)',
            'Prefer use EdgeInsets.symmetric(horizontal: 3, vertical: 2)',
            'Prefer use EdgeInsetsDirectional.only(start: 3, bottom: 2)',
            'Prefer use EdgeInsetsDirectional.only(start: 1.0, top: 1.0)',
            'Prefer use EdgeInsetsDirectional.all(12.0)',
            'Prefer use EdgeInsetsDirectional.all(1.0)',
            'Prefer use EdgeInsets.symmetric(horizontal: 3.0, vertical: 2.0)',
            'Prefer use EdgeInsetsDirectional.only(start: 3.0, bottom: 2.0)',
            'Prefer use EdgeInsets.zero',
          ],
          replacements: [
            'EdgeInsetsDirectional.only(start: 1, top: 1)',
            'EdgeInsetsDirectional.all(12)',
            'EdgeInsetsDirectional.all(1)',
            'EdgeInsets.symmetric(horizontal: 3, vertical: 2)',
            'EdgeInsetsDirectional.only(start: 3, bottom: 2)',
            'EdgeInsetsDirectional.only(start: 1.0, top: 1.0)',
            'EdgeInsetsDirectional.all(12.0)',
            'EdgeInsetsDirectional.all(1.0)',
            'EdgeInsets.symmetric(horizontal: 3.0, vertical: 2.0)',
            'EdgeInsetsDirectional.only(start: 3.0, bottom: 2.0)',
            'EdgeInsets.zero',
          ],
          locationTexts: [
