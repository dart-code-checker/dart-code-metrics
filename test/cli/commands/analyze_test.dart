...
const _usage = 'Collect code metrics, rules and anti-patterns violations.\n'
    ...
    '    --sdk-path=<directory-path>                   Dart SDK directory path. Should be provided only when you run the application as compiled Windows executable(https://dart.dev/tools/dart-compile#exe) and automatic Dart SDK path detection fails.\n'
