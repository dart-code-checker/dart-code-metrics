...
const _examplePath =
    'test/obsoleted/rules/member_ordering/examples/example.dart';
const _multipleClassesExamplePath =
    'test/obsoleted/rules/member_ordering/examples/multiple_classes_example.dart';
const _angularExamplePath =
    'test/obsoleted/rules/member_ordering/examples/angular_example.dart';
const _alphabeticalExamplePath =
    'test/obsoleted/rules/member_ordering/examples/alphabetical_example.dart';
