...
void main() {
  test('PreferIntlArgsRule reports about not found issues', () {
    ...
    expect(
      ...
      equals([
        'Parameter args should be exist',
        'Parameter item should be contains in args',
        'Parameter should not be exist, because is not used',
        'Item should not be exist, because is not used',
        'Parameter args should not be exist',
        'Args item should be contains in parameters',
        'Interpolation must be contains in parameters',
        'Parameter args should not be exist',
        'Args item should be contains in parameters',
        'Args item should be contains in parameters',
        ...
        'Item should be simple identifier',
        'Parameter item should be contains in args',
        'Interpolation must be contains in args',
        'Parameter item should be contains in args',
        'Interpolation must be contains in args',
        'Args item should be contains in parameters',
        'Interpolation must be contains in parameters',
