...
import 'rules_list/format_single_line_comment/format_single_line_comment_rule.dart';
...
final _implementedRules = <String, Rule Function(Map<String, Object>)>{
  ...
  FormatSingleLineCommentRule.ruleId: (config) =>
      FormatSingleLineCommentRule(config),
